...
-- WARNING: This will delete all existing data in policies, users, and claims tables
...
CREATE INDEX idx_policies_stripe_session_id ON policies(stripe_session_id);
CREATE INDEX idx_policies_stripe_subscription_id ON policies(stripe_subscription_id);
